...
ax.set_title("Local Fiber: 98.7% Accurate",fontsize=title_fontsize,pad=40)
plt.tight_layout()
plt.savefig("local.png",dpi=200,bbox_inches='tight')
plt.savefig("local.pdf",dpi=200,bbox_inches='tight')
plt.savefig("local.svg",dpi=200,bbox_inches='tight')
plt.show(block=True)